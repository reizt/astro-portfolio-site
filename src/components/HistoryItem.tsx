...
export const HistoryItem: FC<Props> = ({ month, children, className = '', ...restProps }) => {
  return (
    <div className={`group relative flex flex-col pl-32 xl:flex-row xl:items-center ${className}`} {...restProps}>
      <i
        className={`absolute -left-6 top-0 flex h-16 w-16 items-center justify-center rounded-full bg-blue shadow-dot shadow-blue duration-150 group-hover:-left-10 group-hover:h-24 group-hover:w-24 sm:top-1/2 sm:-translate-y-1/2`}
      >
